<html>
    ...
    <body>
        <h1><a href="#" onclick="redirect();">Click here to redirect to the Winds ${version} download page...</a></h1>
        <p class="notice">Or, select a download link for your OS from below:</p>
        <a href="https://s3.amazonaws.com/winds-2.0-releases/releases/Winds-${version}.dmg" title="macOS - v${version}">
            <svg width="20px" height="24px" viewBox="0 0 20 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <defs></defs>
                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="iconmonstr-apple-os-1" fill="#000000" fill-rule="nonzero">
        ...
        <a href="https://s3.amazonaws.com/winds-2.0-releases/releases/Winds%20Setup%20${version}.exe" title="Windows - v${version}">
            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <defs></defs>
                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="iconmonstr-windows-os-1" fill="#000000" fill-rule="nonzero">
        ...
        <a href="https://s3.amazonaws.com/winds-2.0-releases/releases/winds-${version}-x86_64.AppImage" title="AppImage - v${version}">
            <svg width="18px" height="24px" viewBox="0 0 18 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <defs></defs>
                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="iconmonstr-linux-os-1" fill="#000000" fill-rule="nonzero">
            ...
            function redirect() {
            	...
            	if (os.indexOf('Mac') != -1) {
            		window.location.href =
            			'https://itunes.apple.com/us/app/winds-by-getstream-io/id1381446741';
            	} else if (os.indexOf('Linux') != -1 || os.indexOf('X11') != -1) {
            		window.location.href = 'https://snapcraft.io/winds';
            	} else if (os.indexOf('Windows') != -1) {
            		window.location.href =
            			'https://s3.amazonaws.com/winds-2.0-releases/releases/Winds%20Setup%20${version}.exe';
            	} else {
