...
**Due to the overwhelming success of Wind's launch, we could use a bit of help. We're hiring a remote Node full-stack dev to work on this open source project full time. Contact tommaso@getstream.io for details. Due to budget limitations, the position is a better match for developers outside of the US.**
