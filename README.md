> **NOTICE**: Winds v2.0 is under active development and will be released in early 2018. It's feature packed with all kinds of goodies and we're confident as a team that everyone will enjoy the next release. Please stay tuned for updates and follow the [GetStream.io blog](https://getstream.io/blog). For a quick update on Winds v2.0, please read the following blog post: https://medium.com/getstream-io/announcing-winds-2-0-an-electron-app-with-support-for-rss-podcasts-d13dbe812477. Thank you for your support! 🚀
