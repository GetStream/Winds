	...
	describe('invalid job', () => {
		it('should not update data', async () => {
			const testCases = [
				...
				{ type: 'episode', url: '' },
				{ type: 'article', url: '' },
				{ type: 'rss', url: '', update: true },
				{ type: 'podcast', url: '', update: true },
				{ type: 'episode', url: '', update: true },
				{ type: 'article', url: '', update: true },
				{ type: 'rss', url: undefined },
				{ type: 'podcast', url: undefined },
				{ type: 'episode', url: undefined },
				{ type: 'article', url: undefined },
				{ type: 'rss', url: undefined, update: true },
				{ type: 'podcast', url: undefined, update: true },
