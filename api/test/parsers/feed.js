...
const rssTestData = [
	...
	},
	{
		...
		expectations: {
			...
			articlesLength: 12,
			firstArticleUrl: 'https://getstream.io/blog/try-out-the-stream-api-with-postman',  // normalize-url drops trailing slash
	...
	},
	{
		...
		expectations: {
			...
			link: 'https://medium.com/topic/technology?source=rss-------8-----------------technology',
			description: 'Technology on Medium: The download.',
			articlesLength: 10,
			firstArticleUrl: 'https://shift.newco.co/apple-wants-its-phones-back-d0d77142c7d?source=rss-------8-----------------technology',
	...
	},
	{
		...
		expectations: {
			...
			link: 'https://hackernoon.com/tagged/software-development?source=rss----3a8144eabfe3--software_development',
			description: 'Latest stories tagged with Software Development in Hacker Noon on Medium',
			articlesLength: 10,
			firstArticleUrl: 'https://hackernoon.com/surveyjs-plugin-for-wordpress-9f42d9219db0?source=rss----3a8144eabfe3--software_development',
	...
	},
	{
		...
		expectations: {
			...
			articlesLength: 10,
			firstArticleUrl: 'https://djangoproject.com/weblog/2018/jun/01/bugfix-release',  // normalize-url drops 'www' subdomain, trailing slash
	...
	},
	{
		...
		expectations: {
			...
			articlesLength: 10,
			firstArticleUrl: 'https://weblog.rubyonrails.org/2018/5/27/this-week-in-rails-enumerable-index_with-transaction-fixes-and-more',  // normalize-url drops trailing slash
	...
	},
	{
		...
		expectations: {
			...
			articlesLength: 20,
			firstArticleUrl: 'http://tmz.com/2018/06/06/kate-spade-suicide-husband-andy-divorce-depressed',  // normalize-url drops 'www' subdomain, trailing slash
			firstArticleTitle: 'Kate Spade Depressed Before Suicide Because Husband Wanted a Divorce',
		},
	},
	{
		...
		expectations: {
			...
			articlesLength: 30,
			firstArticleUrl: 'https://treehugger.com/green-food/7-savory-recipes-use-rhubarb.html',  // normalize-url drops 'www' subdomain
	...
	},
	{
		...
		expectations: {
			...
			description: 'Perez Hilton dishes up the juiciest celebrity gossip on all your favorite stars, from Justin Bieber to Kim Kardashian. Are you up-to-date on Hollywood\'s latest scandal?!',
			articlesLength: 10,
			firstArticleUrl: 'http://perezhilton.com/2018-06-05-kate-spade-reta-saffo-sister-mental-illness-reported-suicide',
			firstArticleTitle: 'Kate Spade\'s Sister Says The Designer Suffered From Years Of Mental Illness; Reported Suicide \'Not Unexpected\'',
		},
	},
	{
		filename: 'kottke',
		expectations: {
			...
			articlesLength: 40,
			firstArticleUrl: 'https://kottke.org/18/06/ten-guidelines-for-nurturing-a-thriving-democracy-by-bertrand-russell',
			firstArticleTitle: 'Ten guidelines for nurturing a thriving democracy by Bertrand Russell',
		},
	},
	{
		filename: 'boingboing',
		expectations: {
			...
			articlesLength: 30,
			firstArticleUrl: 'https://boingboing.net/2018/06/06/heres-how-the-hawaiian-isl.html',
...
const podcastTestData = [
	{
		...
		expectations: {
			...
			image: 'https://static.giantbomb.com/uploads/original/11/110673/2927815-3756859778-28940.png',
			episodesLength: 649,
			firstPodcastUrl: 'https://giantbomb.com/podcasts/giant-bombcast-534-forklift-academy/1600-2347',  // normalize-url drops 'www' subdomain, trailing slash
	...
	},
	{
		...
		expectations: {
			...
			episodesLength: 28,
			firstPodcastUrl: 'http://feeds.serialpodcast.org/~r/serialpodcast/~3/Dx1_WiYrlg0/live',
	...
	},
	{
		...
		expectations: {
			...
			image: 'https://content.production.cdn.art19.com/images/44/f7/bb/b8/44f7bbb8-40ce-4a63-8ab8-9bc1cd71f4be/ba7aed20b307b76c2a8ba9a6473fd4c831179c6a24e20bf3179af4f11e06bc96968fca9edf17f4d55b5cae6ef3d97484f6b34b288426d42c5f59a515a8a37d67.jpeg',
			episodesLength: 74,
			firstPodcastUrl: 'https://dts.podtrac.com/redirect.mp3/rss.art19.com/episodes/90f12a60-07c8-4c8d-ad93-90278046e861.mp3',
	...
	},
	{
		...
		expectations: {
			...
			image: 'http://static.megaphone.fm/podcasts/806b466c-ef0c-11e6-b531-afa5d3e8b9e3/image/uploads_2F1522339695064-fiy1a2pf3tb-64aa58ac9b5bcdcf9e3145121e2a85eb_2FTheHabitat-final-cover.png',
			episodesLength: 10,
	...
	},
	{
		...
		expectations: {
			...
			image: 'http://static.megaphone.fm/podcasts/84e4a5c4-2de7-11e8-98b7-87f52d4374c4/image/uploads_2F1521733294980-xkcadcjrpar-7faa79cc84d505be934000c158cf54f5_2Fatlanta-monster-main-art.jpg',
			episodesLength: 17,
			firstPodcastUrl: 'https://podtrac.com/pts/redirect.mp3/traffic.megaphone.fm/HSW7011693605.mp3',  // normalize-url drops 'www' subdomain
	...
	},
	{
		...
		expectations: {
			...
			image: 'https://content.production.cdn.art19.com/images/be/a6/a3/9f/bea6a39f-64ec-4a6f-9fba-80efbb45db2c/c9ca312ba4d3ac1415f0c0421adfce07829f7677e20fc272d3e421fb1c180fbc9dc9294d5aa3efa7480153c24daffca835fb436a1de59d4c9efb6453f111968f.jpeg',
			episodesLength: 70,
			firstPodcastUrl: 'http://rss.art19.com/episodes/91aaef4e-5a1e-4aef-b66a-84432e29f9eb.mp3',
	...
	},
	{
		...
		expectations: {
			title: 'Making Obama',
			link: 'https://www.wbez.org/shows/making-obama/71b8de57-b2be-4e03-8481-683258de3ec1',
			image: 'https://api.wbez.org/v2/images/6eb13711-5af1-4845-90ed-9dcd9a8e8da8.jpg?width=1400&height=1400',
			episodesLength: 15,
			firstPodcastUrl: 'https://wbez.org/shows/making-obama/obama-bonus-the-decision/f15250d1-fccb-44e4-b14e-368525b08bfc',  // normalize-url drops 'www' subdomain
		...
		for (let test of podcastTestData) {
			it(`should parse podcast feed ${test.filename}`, async () => {
				...
				if (test.expectations.episodesLength > 0) {
					expect(podcastResponse.episodes[0].title).to.equal(test.expectations.firstPodcastTitle);
					expect(podcastResponse.episodes[0].url).to.equal(test.expectations.firstPodcastUrl);
					expect(podcastResponse.episodes[0].publicationDate).to.eql(test.expectations.firstPodcastPublicationDate);
				}
			});
		}
	});
